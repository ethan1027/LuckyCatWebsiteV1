const Roadmap = () => (
  ...
  <div className="relative wrap overflow-hidden p-10 h-full">
    ...
    <div className="mb-8 flex justify-between items-center w-full right-timeline">
      ...
      <div className="z-20 flex items-center order-1 shadow w-8 h-8 rounded-full">
        <h1 className="mx-auto font-semibold text-lg">&nbsp;</h1>
      </div>
      <div className="order-1 rounded-lg shadow w-5/12 px-6 py-4 hover:shadow-xl transition-shadow duration-300 ease-in-out">
    ...
    <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
      ...
      <div className="order-1 bg-red-400 rounded-lg shadow w-5/12 px-6 py-4 hover:shadow-xl transition-shadow duration-300 ease-in-out">
        <h3 className="mb-3 font-bold text-xl">Lorem Ipsum</h3>
    ...
    <div className="mb-8 flex justify-between items-center w-full right-timeline">
      ...
      <div className="order-1 bg-gray-400 rounded-lg shadow w-5/12 px-6 py-4 hover:shadow-xl transition-shadow duration-300 ease-in-out">
