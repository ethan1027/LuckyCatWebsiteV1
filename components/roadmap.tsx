const Roadmap = (props) => (
  ...
  <div className="relative wrap overflow-hidden p-10 h-full">
    ...
    <div className="mb-8 flex justify-between items-center w-full right-timeline">
      ...
      <div className="order-1 bg-white rounded-lg shadow w-5/12 px-6 py-4 shadow-2xl transition duration-500 ease-in-out hover:shadow-yellow transform hover:-translate-y-2 hover:scale-110">
