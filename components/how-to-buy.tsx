export default function HowToBuy() {
  ...
  <div className="container mx-auto mt-10 h-auto flex lg:flex-row md:flex-column justify-center">
      <div className="bg-yellow-100 mx-5 p-5 lg:w-1/2 md:w-full rounded-3xl shadow-lg hover:shadow-2xl pl-4 ">
          ...
          <div className='text-sm'>1. Download the app, Trust Wallet. 💸</div>
          <div className='text-sm'>2. Purchase BNB or BSC using TrustWallet.</div>
          <div className='text-sm'>3. </div>
          <div className='text-sm'>4. </div>
          <div className='text-sm'>5. Once on PancakeSwap, connect your wallet at the top and ensure 'smart chain' is selected by clicking the symbol on the corner of the screen. Then put the amount of BNB you wish to spend in the "From" box.</div>
          <div className='text-sm'>6. Change your slippage to 12% and press "Swap"</div>
          <div className='text-sm'>7. Confirm the transaction and... HODL 😊</div>
      </div>
